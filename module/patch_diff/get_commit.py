...
kernel_dir="/export/disk1T1/bsp_work/TI_AM335X/TI_SDK/SDK8/board-support/linux-3.14.26-g2489c02"
...
for line in cont.readlines():
    ...
    if line[:7] == "(cherry":
        commit_id = line[27:-2]
        cmd1= "cd "+ kernel_dir +"; "+"git show -s --format=%s " + commit_id + "  2>/dev/null"
